...
const About = () => {
  return (
    <>
    <section id="about-me" className='text-green-500 justify-start items-start flex px-8 mx-6 py-2 sm:mx-8 md:mx-14 sm:px-12 lg:px-16'>
        <div className="max-w-3xl text-left">
            <h1 className='text-3xl text-green-500 font-bold text-start mb-5'>About Me</h1>
            <p className='text-lg text-slate-400 mb-2 text-justify'>
